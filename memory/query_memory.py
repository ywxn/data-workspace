...
class UnifiedMemoryService:
            ...
            with open(file_path, 'r', encoding='utf-8') as f:
                for line in f:
                    ...
                    try:
                        ...
                        if (prompt_lower in record.user_prompt.lower() or
                            prompt_lower in record.normalized_prompt.lower()):
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "retention_limit": self.rolling_n if self.retention_policy == RetentionPolicy.ROLLING_N else self.ttl_days
        }
