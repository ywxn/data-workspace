...
class TestTableSelection:
    ...
    def test_select_single_table(self):
        ...
        similarities = {"users": 0.85, "orders": 0.45, "products": 0.30}
    ...
    def test_no_suitable_table(self):
        ...
        similarities = {"users": 0.25, "orders": 0.20, "products": 0.15}
...
class TestColumnSelection:
    ...
    def test_select_relevant_columns(self):
        ...
        threshold = 0.7
        selected_columns = [
            col for col, score in column_relevance.items() if score >= threshold
        ]
...
class TestMultiTableScenarios:
    ...
    def test_complex_join_logic(self):
        ...
        query = (
            "Show customers with orders containing products from electronics category"
        )
...
class TestPerformance:
    ...
    def test_selection_with_many_tables(self):
        ...
        best_tables = sorted(similarities.items(), key=lambda x: x[1], reverse=True)[
            :10
        ]
...
class TestFallbackStrategy:
    ...
    def test_ask_user_when_uncertain(self):
        ...
        similarities = {"users": 0.52, "orders": 0.48}
