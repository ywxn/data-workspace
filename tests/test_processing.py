...
class TestDataCleaning:
    ...
    def test_fill_missing_values(self):
        ...
        data = {"id": [1, 2, 3], "score": [85, None, 92]}
    ...
    def test_remove_null_rows(self):
        ...
        data = {"id": [1, 2, 3], "name": ["John", None, "Jane"]}
    ...
    def test_data_type_conversion(self):
        ...
        data = {"id": ["1", "2", "3"], "score": ["85.5", "92.3", "88.1"]}
...
class TestDataTransformation:
    ...
    def test_create_bins(self):
        ...
        df = pd.DataFrame(data)
        df["age_group"] = pd.cut(
            df["age"], bins=[0, 30, 60, 100], labels=["Young", "Middle", "Senior"]
        )
...
class TestDataAggregation:
    ...
    def test_average_aggregation(self):
        ...
        data = {"category": ["A", "A", "B", "B"], "score": [80, 90, 70, 85]}
...
class TestDataValidation:
    ...
    def test_validate_data_integrity(self):
        ...
        data = {"id": [1, 2, 3], "parent_id": [None, 1, 1]}
...
class TestDataFormatting:
    ...
    def test_format_numbers(self):
        ...
        data = {"value": [1234.56789, 9876.54321]}
    ...
    def test_truncate_text(self):
        ...
        data = {"description": ["This is a very long description", "Short"]}

        df = pd.DataFrame(data)
        df["truncated"] = df["description"].apply(
...
class TestLargeDatasetProcessing:
    ...
    def test_process_million_rows(self):
        ...
        n = 1000000
        data = {"id": range(n), "value": np.random.randint(0, 100, n)}
